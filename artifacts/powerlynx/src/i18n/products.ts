...
const categoryTranslations: Partial<Record<LanguageCode, Record<string, string>>> = {
  ES: { "Line Sets": "Juegos de líneas", Motors: "Motores", "Thermal Camera": "Cámara termográfica", Torch: "Soplete", "Manifold Gauge": "Manómetro múltiple", "Refrigerant Hoses": "Mangueras para refrigerante", "Flaring Tool": "Abocardador", "Tube Expander": "Expansor de tubos", "Tube Straightener": "Enderezador de tubos", "Tube Cutter": "Cortatubos", "Internal & External Reamer": "Escariador interno y externo", "Tube Deburring Tool": "Desbarbador de tubos", "Ratcheting Wrench": "Llave de carraca", "Folding Knife": "Cuchillo plegable multiuso", "Dual-Blade Folding Knife": "Cuchillo plegable de doble hoja", "LED Penlight": "Linterna LED tipo lápiz", "LED Headlight": "Linterna frontal LED" },
  PT: { "Line Sets": "Conjuntos de linhas", Motors: "Motores", "Thermal Camera": "Câmera termográfica", Torch: "Maçarico", "Manifold Gauge": "Manifold", "Refrigerant Hoses": "Mangueiras para refrigerante", "Flaring Tool": "Flangeador", "Tube Expander": "Expansor de tubos", "Tube Straightener": "Endireitador de tubos", "Tube Cutter": "Cortador de tubos", "Internal & External Reamer": "Alargador interno e externo", "Tube Deburring Tool": "Ferramenta de rebarbação", "Ratcheting Wrench": "Chave catraca", "Folding Knife": "Faca dobrável utilitária", "Dual-Blade Folding Knife": "Faca dobrável de duas lâminas", "LED Penlight": "Lanterna LED", "LED Headlight": "Lanterna frontal LED" },
  FR: { "Line Sets": "Kits de lignes", Motors: "Moteurs", "Thermal Camera": "Caméra thermique", Torch: "Chalumeau", "Manifold Gauge": "Manifold", "Refrigerant Hoses": "Flexibles frigorifiques", "Flaring Tool": "Dudgeonnière", "Tube Expander": "Expandeur de tubes", "Tube Straightener": "Redresseur de tubes", "Tube Cutter": "Coupe-tube", "Internal & External Reamer": "Alésoir intérieur et extérieur", "Tube Deburring Tool": "Ébavureur de tubes", "Ratcheting Wrench": "Clé à cliquet", "Folding Knife": "Couteau pliant utilitaire", "Dual-Blade Folding Knife": "Couteau pliant à double lame", "LED Penlight": "Lampe stylo LED", "LED Headlight": "Lampe frontale LED" },
  DE: { "Line Sets": "Leitungssätze", Motors: "Motoren", "Thermal Camera": "Wärmebildkamera", Torch: "Brenner", "Manifold Gauge": "Manometer", "Refrigerant Hoses": "Kältemittelschläuche", "Flaring Tool": "Bördelwerkzeug", "Tube Expander": "Rohr-Aufweiter", "Tube Straightener": "Rohr-Richtwerkzeug", "Tube Cutter": "Rohrschneider", "Internal & External Reamer": "Innen- und Außenentgrater", "Tube Deburring Tool": "Rohr-Entgrater", "Ratcheting Wrench": "Ratschenschlüssel", "Folding Knife": "Universal-Klappmesser", "Dual-Blade Folding Knife": "Klappmesser mit zwei Klingen", "LED Penlight": "LED-Stiftlampe", "LED Headlight": "LED-Stirnlampe" },
  JA: { "Line Sets": "ラインセット", Motors: "モーター", "Thermal Camera": "サーマルカメラ", Torch: "トーチ", "Manifold Gauge": "マニホールドゲージ", "Refrigerant Hoses": "冷媒ホース", "Flaring Tool": "フレアリングツール", "Tube Expander": "チューブエキスパンダー", "Tube Straightener": "チューブストレートナー", "Tube Cutter": "チューブカッター", "Internal & External Reamer": "内外面リーマー", "Tube Deburring Tool": "チューブ面取りツール", "Ratcheting Wrench": "ラチェットレンチ", "Folding Knife": "折りたたみ万能ナイフ", "Dual-Blade Folding Knife": "2枚刃折りたたみナイフ", "LED Penlight": "LED ペンライト", "LED Headlight": "LED ヘッドライト" },
  KO: { "Line Sets": "라인 세트", Motors: "모터", "Thermal Camera": "열화상 카메라", Torch: "토치", "Manifold Gauge": "매니폴드 게이지", "Refrigerant Hoses": "냉매 호스", "Flaring Tool": "플레어링 공구", "Tube Expander": "튜브 확관기", "Tube Straightener": "튜브 교정기", "Tube Cutter": "튜브 커터", "Internal & External Reamer": "내·외경 리머", "Tube Deburring Tool": "튜브 디버링 공구", "Ratcheting Wrench": "래칫 렌치", "Folding Knife": "접이식 다용도 나이프", "Dual-Blade Folding Knife": "더블 블레이드 접이식 나이프", "LED Penlight": "LED 펜라이트", "LED Headlight": "LED 헤드라이트" },
  ZH: { "Line Sets": "管组", Motors: "电机", "Thermal Camera": "热成像相机", Torch: "焊炬", "Manifold Gauge": "歧管压力表", "Refrigerant Hoses": "制冷剂软管", "Flaring Tool": "扩口工具", "Tube Expander": "扩管器", "Tube Straightener": "管路校直器", "Tube Cutter": "割管器", "Internal & External Reamer": "内外两用铰刀", "Tube Deburring Tool": "管路去毛刺工具", "Ratcheting Wrench": "棘轮扳手", "Folding Knife": "多用途折叠刀", "Dual-Blade Folding Knife": "双刃折叠刀", "LED Penlight": "LED 笔灯", "LED Headlight": "LED 头灯" },
};
categoryTranslations["ZH-TW"] = { ...categoryTranslations.ZH, "Line Sets": "管組", Motors: "馬達", "Thermal Camera": "熱成像相機", "Refrigerant Hoses": "冷媒軟管", "Tube Deburring Tool": "管路去毛刺工具", "Internal & External Reamer": "內外兩用鉸刀", "Folding Knife": "多用途折疊刀", "Dual-Blade Folding Knife": "雙刃折疊刀", "LED Penlight": "LED 筆燈", "LED Headlight": "LED 頭燈" };

const categoryGroupTranslations: Partial<Record<LanguageCode, Record<string, string>>> = {
  ES: { "HVAC Parts & Supplies": "Piezas y suministros HVAC", "HVAC Tools and Instruments": "Herramientas e instrumentos HVAC", "Tubing Tools": "Herramientas para tubos", "Utility & Hand Tools": "Herramientas manuales y multiuso" },
  PT: { "HVAC Parts & Supplies": "Peças e suprimentos HVAC", "HVAC Tools and Instruments": "Ferramentas e instrumentos HVAC", "Tubing Tools": "Ferramentas para tubos", "Utility & Hand Tools": "Ferramentas manuais e utilitárias" },
  FR: { "HVAC Parts & Supplies": "Pièces et fournitures HVAC", "HVAC Tools and Instruments": "Outils et instruments HVAC", "Tubing Tools": "Outils pour tubes", "Utility & Hand Tools": "Outils manuels et utilitaires" },
  DE: { "HVAC Parts & Supplies": "HVAC-Teile und -Zubehör", "HVAC Tools and Instruments": "HVAC-Werkzeuge und -Instrumente", "Tubing Tools": "Rohrwerkzeuge", "Utility & Hand Tools": "Universal- und Handwerkzeuge" },
  JA: { "HVAC Parts & Supplies": "HVAC 部品・サプライ", "HVAC Tools and Instruments": "HVAC ツール・計測機器", "Tubing Tools": "チューブ工具", "Utility & Hand Tools": "ユーティリティ・手工具" },
  KO: { "HVAC Parts & Supplies": "HVAC 부품 및 소모품", "HVAC Tools and Instruments": "HVAC 공구 및 계측기", "Tubing Tools": "튜빙 공구", "Utility & Hand Tools": "유틸리티 및 수공구" },
  ZH: { "HVAC Parts & Supplies": "HVAC 零件与耗材", "HVAC Tools and Instruments": "HVAC 工具与仪器", "Tubing Tools": "管路工具", "Utility & Hand Tools": "多用途与手动工具" },
  "ZH-TW": { "HVAC Parts & Supplies": "HVAC 零件與耗材", "HVAC Tools and Instruments": "HVAC 工具與儀器", "Tubing Tools": "管路工具", "Utility & Hand Tools": "多用途與手動工具" },
};
...
export function localizedCategoryGroupLabel(group: string, language: LanguageCode) {
  return categoryGroupTranslations[language]?.[group] ?? group;
}
